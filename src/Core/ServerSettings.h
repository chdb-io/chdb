...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, background_schedule_pool_size, 8, "The maximum number of threads that will be used for constantly executing some lightweight periodic operations.", 0) \
