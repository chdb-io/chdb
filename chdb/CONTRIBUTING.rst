...
``chdb`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/chdb
.. _issue tracker: https://github.com/<USERNAME>/chdb/issues
.. <-- end -->
