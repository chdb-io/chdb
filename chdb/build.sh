...
cd ${BUILD_DIR}
# Enable Address Sanitizer via CMake option
CMAKE_ARGS="-DSANITIZE=address -DCMAKE_BUILD_TYPE=${build_type} -DENABLE_THINLTO=0 -DENABLE_TESTS=0 -DENABLE_CLICKHOUSE_SERVER=0 -DENABLE_CLICKHOUSE_CLIENT=0 \
