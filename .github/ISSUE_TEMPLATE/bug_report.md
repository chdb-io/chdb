...
<!-- Paste the full traceback. For crashes (SIGSEGV / SIGABRT / SIGBUS),
     please capture a native stack trace as well — see CONTRIBUTING.md
     → "Capture the stack trace before changing code on a crash" for
     the gdb/lldb/faulthandler flow. -->
