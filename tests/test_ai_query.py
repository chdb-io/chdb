...
class TestAIQuery(unittest.TestCase):
    def setUp(self):
        ...
        connection_str = f"file::memory:?ai_base_url={base_url}&ai_model={ai_model}"
    ...
    def test_ai_query_lists_users_in_order(self):
        ...
        try:
            ...
            df = self.conn.query(str(generated_sql), fmt="DataFrame")
            ...
            if (
                ...
                self.skipTest("AI provider not configured/enabled")
            raise
